...
*Created by maddie , last modified on Oct 30, 2024*
...
1. Essential information or directives that help facilitate Service Operations activities more efficiently. They guide on critical aspects of a property or service provider's working schedule that are necessary to understand their operations or services.
  ...
  1. <u>Appropriate Use Cases</u>:

    1. **Property Information:** Include contextual advice about the property, like where things are located for the benefit of service providers.
    2. **Service Provider Working Hours:** On the Service Provider account, specify their available working hours.
    3. **Roto Rooter:**If a PM never wants a Roto Rooter Service Provider assigned to their WOs, this can be placed as a Critical Note on the account.
...
1. Information that is required to prevent incorrect dispatching for emergencies. These notes show up once in the entire work order lifecycle which is right before dispatching.
  ...
  1. <u>Appropriate Use Cases</u>:
    ...
    1. **Pre-Dispatch Escalations.**Include a list of contacts to reach out to before dispatching a service provider.

      1. Note that PM escalations prior to dispatching can be attempted via all contact methods. This does not mean waiting for responses; moving forward is permissible if escalation contacts are unresponsive.
