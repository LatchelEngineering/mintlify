---
title: "On-Call Rotation: Getting Started"
sidebarTitle: "Overview"
---

Not every issue that comes through your inbox needs a full work order. Sometimes a team just needs to be notified fast — no scheduling, no invoicing, no back-and-forth. That's exactly what on-call rotations are built for.
...
<Note>
  **Available on all maintenance subscription packages.** On-call rotations are accessible to any customer on a maintenance plan. For questions about your plan or pricing, reach out to your Customer Success Manager.
</Note>

### **How It Works**

An on-call rotation is a structured system that automatically contacts a predefined list of technicians or team members — in a specific order or all at once — when a qualifying issue is submitted. It's triggered by intake rules you configure, and it operates independently of the standard work order process.
...
When an alert goes out, the on-call technician can acknowledge it by replying to the call or text, or taking no action which passes the alert to the next person in the rotation. If no one acknowledges after all attempts, the final escalation group receives an email notification.

On-call rotations are best suited for situations where immediate awareness matters but a full work order workflow isn't necessary — such as security teams handling lockouts, internal staff managing parking disputes, or teams receiving alerts for non-maintenance events like power outages.

### **Why This Matters**

On-call rotations close the gap between a resident submitting an issue and the right person being aware of it — in real time, without manual intervention. Here's why that matters for your team:
...
<CardGroup cols={2}>
  ...
  <Card title="Lighter workflow for simple issues" color="#7ed5d5" icon="2" iconType="duotone">
    Not every situation needs invoicing and scheduling. On-call keeps things simple when speed is the priority.
  </Card>
  ...
  <Card title="Covers non-maintenance needs" color="#7ed5d5" icon="6" iconType="duotone">
    Teams outside of maintenance — security, parking, facilities — can use on-call without needing the full maintenance workflow.
  </Card>
</CardGroup>
