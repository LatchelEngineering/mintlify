...
<Note>
  Chrome plugin users can influence the **"is\_active"** field of a property by hiding or unhiding the object in your PMS.
</Note>
...
- move in date
- move out date
- is\_active in Latchel (based on the residents move in and move out date)
...
**I. Properties and Residents -** Manually created properties and residents in Latchel will not sync to your platform. Hence, the option to create new properties and residents in the Latchel console is unavailable.

**II. Work orders -** Work orders are created/updated in Platform or Latchel when the following are true:
...
<Icon icon="camera-movie" iconType="sharp-duotone-solid" color="#ff9b8a" /> **Watch how this works below!**

<iframe width="100%" height="420" src="https://www.loom.com/embed/9e52e22b0d284fae80faa7cb7c8cb653?sid=444a8506-09a3-4ed1-b0ce-ddf54c4d9583" title="How to Accept & Schedule a Job" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />

**III. File Sync** - This feature is not currently supported for the Platform. 

**To learn more about Latchel Integration, please visit:**
...
<Tip>
  You may also contact Latchel's Product Support via [team@latchel.com](mailto:team@latchel.com) to know which option works best for your company.
</Tip>

## Excluding Properties from Import

PMs can now choose to exclude specific properties from being imported into Latchel during a sync. This is useful for units that should not be managed through Latchel, such as:
...
To exclude a property, use the **Exclude from Property Sync** button found within your PMS (e.g., in AppFolio, this button appears directly on the property page). Excluded properties will be skipped in all future syncs.

<Note>
  To re-include a property, simply remove the exclusion in your PMS. It will be picked up in the next sync.
</Note>