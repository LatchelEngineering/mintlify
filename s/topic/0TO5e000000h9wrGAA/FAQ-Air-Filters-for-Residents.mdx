...
<Card title="What Size Air Filter Do I need? | Filter Time" color="#ff9b8a" icon="camera-movie" iconType="duotone" horizontal href="https://youtu.be/X-NTd8xZFzA?si=xD5AUSQSRQ_mFILy">
...
<CardGroup cols={2}>
  <Card title="Need an air filter? Please complete this typeform." color="#ff9b8a" icon="file-pen" iconType="duotone" horizontal href="https://latchel.typeform.com/to/ve5O9pds">
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Damaged, wrong, missing, no filter? Fill out this typeform." color="#ff9b8a" icon="message-pen" iconType="duotone" horizontal href="https://latchel.typeform.com/to/lKZfspdn">
  </Card>
</CardGroup>